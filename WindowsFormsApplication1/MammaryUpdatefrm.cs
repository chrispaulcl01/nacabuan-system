...
{
    public partial class MammaryUpdatefrm : Form
    {
        public MammaryUpdatefrm()
        {
            InitializeComponent();
        }
        ...
        {
            if (patient.UpdateMammaryGlandPatient(this.txtPetID.Text, this.txtOwnersName.Text, this.txtPhoneNumber.Text, this.txtAddress.Text, this.txtPatientName.Text,
        ...
        private void MammaryUpdatefrm_Load(object sender, EventArgs e)
        {
