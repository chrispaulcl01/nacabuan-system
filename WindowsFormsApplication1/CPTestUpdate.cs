...
{
    public partial class CPTestUpdate : Form
    {
        public CPTestUpdate()
        {
            InitializeComponent();
        ...
        private void CPTestUpdate_Load(object sender, EventArgs e)
        {
        ...
        {
            if (patient.UpdateCPTPatient(this.txtPetID.Text, this.txtOwnersName.Text, this.txtPhoneNumber.Text, this.txtAddress.Text, this.txtPatientName.Text,
