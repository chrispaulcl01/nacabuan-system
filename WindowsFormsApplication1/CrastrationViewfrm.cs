...
{
    public partial class CrastrationViewfrm : Form
    {
        public CrastrationViewfrm()
        {
            InitializeComponent();
        }
        ...
        {
            CrastrationUpdatefrm crasup = new CrastrationUpdatefrm();
            crasup.Show();  
        }
        ...
        private void CrastrationViewfrm_Load(object sender, EventArgs e)
        {
